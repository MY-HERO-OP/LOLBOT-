...
If you want to create your own LOLBOT, please visit the official repository at [https://github.com/] and deploy it on the Render platform or a VPS.""")
        return
...
Example: /scm This is LOLBOT's Sechducast Module""")
    except ValueError:
