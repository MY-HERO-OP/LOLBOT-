...
def button_handler(update: Update, context: CallbackContext):
    ...
    if query.data == "disabled_calculator":
        query.answer(text="Calculator Plugin Disabled by the person who deployed this LOLBOT Variant", show_alert=True)
        return  # Exit the function

    # Handle disabled scientific calculator message
    if query.data == "disabled_sci_calculator":
        query.answer(text="Scientific Calculator Plugin Disabled by the person who deployed this LOLBOT Variant", show_alert=True)
        return  # Exit the function

    # Handle disabled Unit Converter message
    if query.data == "disabled_unit_converter":
        query.answer(text="Unit Converter Plugin Disabled by the person who deployed this LOLBOT Variant", show_alert=True)
        return
