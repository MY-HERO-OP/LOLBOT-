...
def has_user_started_bot(update, message_sender_user_id):
    ...
    user_record = LOLBOT_db["user_and_chat_data"].find_one({"user_id": message_sender_user_id})
...
def prompt_user_to_start_bot_in_pm(update: Update, context: CallbackContext):
    ...
    keyboard = [[InlineKeyboardButton("Start LOLBOT ❄️", url=start_bot_url)]]
