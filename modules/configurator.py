    ...
    def get_db(cls):
        if cls._client is None:
            try:
                ...
                cls._db = cls._client.get_database("LOLBOT")
...
def get_unique_message_for_env(key):
    unique_messages = {
        ...
        "UPSTREAM_REPO_URL": "🔗 URL to the GitHub source code repository, Recommended to use the official LOLBOT Repo.\n\n<b>Required [🔴]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
        "SETUP_BOT_PROFILE": "Automatically setup Bot Name, About and Description at the deploy of LOLBOT instead of manually setup in @BotFather\n\n⚠️ You have been advised to set SETUP_BOT_PROFILE environment variable to <code>False</code> after you set up your LOLBOT profile correctly during the first deployment using /bsettings to prevent unnecessary rate limit errors.\n\n<b>Optional But Recommended to Fill [🔶]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
        "BOT_NAME": "Set New name for LOLBOT!\n\n<b>Optional But Recommended to Fill [🔶]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
        "BOT_ABOUT": "Set New about text for LOLBOT!\n\n<b>Optional But Recommended to Fill [🔶]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
        "BOT_DESCRIPTION": "Set New description for LOLBOT!\n\n<b>Optional But Recommended to Fill [🔶]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
        ...
        "AUTHORIZED_USERS": "🛡️ List of user IDs to give access to LOLBOT's some features.\n\n<b>Required [🔴]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
        ...
        "ENABLE_GLOBAL_G_API": "🌍 Enables or disables global Google Gemini API for AI related features across the LOLBOT.\n\n<b>Optional [🟩]</b>\n<b>For new changes, Restart:</b> <u><i>Required</i></u>",
    ...
    if env_record:
        ...
        if key not in ["MONGODB_URI"]: 
            ...
            text_message += "\n\n⚠️Highly Sensitive ENV\n\n" \
                            "<u>MONGODB_URI</u> is an env that LOLBOT can't edit from the telegram interface. " \
