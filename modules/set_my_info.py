...
new_name = get_env_var_from_db("BOT_NAME") or 'L O L'
new_short_description = get_env_var_from_db("BOT_ABOUT") or 'LOLBOT is your All-in-One AI Personal Assistant 🤖'
new_description = get_env_var_from_db("BOT_DESCRIPTION") or """LOLBOT is a personal AI assistant on Telegram aimed at enhancing productivity through seamless integration of reminders, schedules, broadcasts, and many many more features. 🪄🍃"""
